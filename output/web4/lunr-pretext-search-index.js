...
},
{
  ...
  "body": " Expressions with Fractions    In this section, we learn how to:    Add, subtract, multiply, and divide fractions.  Determine when common denominators are required and when they are not.  Determine when cancelling is permissible in a fraction and when it isn't.     Order of Operations   Representing Addition Geometrically  Suppose and are positive real numbers. Then is geometrically represented by the length of the stick made by gluing a stick of length to a stick of length .  A picture of         The top and bottom of a fraction are in (hidden) parentheses. Affects calculator input.  Mixed fractions, improper fractions, decimal answers. Why improper fractions are the focus.  Two correct (and one incorrect) interpretation of .  "
},
{
  ...
  "number": "1.2",
  "title": "",
  "body": "  In this section, we learn how to:    Add, subtract, multiply, and divide fractions.  Determine when common denominators are required and when they are not.  Determine when cancelling is permissible in a fraction and when it isn't.   "
},
{
  "id": "fig-fraction-meaning",
  "level": "2",
  "url": "sec-expressions-with-fractions.html#fig-fraction-meaning",
  "type": "Figure",
  "number": "1.2.1",
  "title": "",
  "body": " A picture of     "
